...
# Explicit permission allowing this specific API Gateway to invoke the
# Lambda function — Terraform equivalent of the console's automatic
# "Grant API Gateway permission to invoke your Lambda function" step.
